#Presenting an Artificial Neural Network implementation to find out reasons as to why and which customers are leaving the bank and their dependencies on one another. 
